...
my_manager = Manager(1, "Andrés")
my_project_manager = ProjectManager(2, "Daniel", "Proyecto 1")
my_project_manager2 = ProjectManager(3, "Jesús", "Proyecto 2")
my_programmer = Programmer(4, "Sara", "Javascript")
my_programmer2 = Programmer(5, "Felipe", "Python")
my_programmer3 = Programmer(6, "Edgar", "C++")
my_programmer4 = Programmer(7, "Javier", "Kotlin")
